...
public class HotAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        RecommendAdapter.ViewHolder viewHolder = null;
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.hot_adapter, null);
            viewHolder = new RecommendAdapter.ViewHolder(convertView);
